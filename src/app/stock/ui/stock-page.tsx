      ...
      >
        {muebles.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-text-dark mb-1">Sin inventario</h3>
            <p className="text-text-muted text-sm mb-6">Comienza agregando muebles al catálogo</p>
            <button
              onClick={handleAddMueble}
