  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <div className="flex flex-col gap-3 mb-6 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h3 className="font-semibold text-text-primary">Ingresos</h3>
          <p className="text-text-muted mt-0.5">Resumen de ingresos · Scroll para hacer zoom</p>
        </div>

        <div className="flex flex-col gap-2 sm:items-end">
          {/* Total */}
          <div className="sm:text-right">
            <p className="text-2xl font-bold text-success">${totalIngresos.toLocaleString("es-ES", { minimumFractionDigits: 2 })}</p>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <select
              ...
              className="bg-bg-secondary text-text-primary rounded-lg px-3 py-2 border border-border focus:outline-none focus:ring-2 focus:ring-primary/40"
            >
      ...
      <div className="relative">
        ...
        {tooltip && (
          ...
          >
            ...
            <p className="font-bold text-success">${tooltip.value.toLocaleString("es-ES")}</p>
          </div>
        )}
      </div>
    </div>
