...
export function InsumoBarModal({ isOpen, onClose, onSubmit, editingInsumo, saving }: Props) {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={editingInsumo ? "Editar Insumo" : "Nuevo Insumo de Bar"}
    >
